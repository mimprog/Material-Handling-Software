...
(function (h) {
  ...
  n.ext = x = {
    ...
    classes: {},
    build:
      'dt/dt-1.10.18/b-1.5.2/b-colvis-1.5.2/b-flash-1.5.2/b-print-1.5.2/fc-3.2.5/fh-3.1.4/kt-2.4.0/r-2.2.2/sc-1.5.0',
    errMode: 'alert',
    feature: [],
    search: [],
...
(function (f) {
  ...
  var m = f.fn.dataTable,
    n = function (a, b) {
      if (!m.versionCheck || !m.versionCheck('1.10.8'))
        throw 'KeyTable requires DataTables 1.10.8 or newer';
      this.c = f.extend(!0, {}, m.defaults.keyTable, n.defaults, b);
      this.s = {
        dt: new m.Api(a),
        enable: !0,
        focusDraw: !1,
      ...
      if (
        ...
        var l = function () {
          e.one('open.keyTable', function () {
            ...
            .inline(c.s.lastFocus.cell.index());
        };
        if (13 === a)
        ...
        if (-1 !== g.length && (a < g.start || a >= g.start + g.length))
          ...
          if (c === o || !0 === c)
            this._scroll(f(k), f(h.body), i, 'offset'),
              (c = l.table().body().parentNode),
              c !== l.table().header().parentNode &&
                ((c = f(c.parentNode)), this._scroll(c, c, i, 'position'));
          this.s.lastFocus = {
            cell: g,
            node: g.node(),
            relative: {
              row: l.rows({ page: 'current' }).indexes().indexOf(g.index().row),
